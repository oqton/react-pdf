...
export var OutlineInternal = /*#__PURE__*/function (_PureComponent) {
  ...
  function OutlineInternal() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(OutlineInternal)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "onLoadSuccess", function () {
      ...
      callIfDefined(onLoadSuccess, outline);
    });
  ...
  _createClass(OutlineInternal, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", _extends({
        ...
        ref: inputRef
      }, this.eventProps), React.createElement(OutlineContext.Provider, {
...
function Outline(props, ref) {
  return React.createElement(DocumentContext.Consumer, null, function (context) {
    return React.createElement(OutlineInternal, _extends({
      ref: ref
    }, context, props));
  });
}
