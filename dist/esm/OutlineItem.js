...
export var OutlineItemInternal = /*#__PURE__*/function (_PureComponent) {
  ...
  function OutlineItemInternal() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(OutlineItemInternal)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(OutlineItemInternal, [{
    ...
    value: function renderSubitems() {
      ...
      return React.createElement("ul", null, subitems.map(function (subitem, subitemIndex) {
        return React.createElement(OutlineItemInternal, _extends({
...
var OutlineItem = function OutlineItem(props) {
  return React.createElement(DocumentContext.Consumer, null, function (documentContext) {
    return React.createElement(OutlineContext.Consumer, null, function (outlineContext) {
      return React.createElement(OutlineItemInternal, _extends({}, documentContext, outlineContext, props));
    });
  });
};
